    ...
    .then(data => {
        ...
        for (let i = 0; i < total_users; i++) {
            ...
            connect_button.addEventListener('click', function () {
                ...
                const data = { sender_email: sender_email, receiver_id: receiver_id }; // Corrected object construction
                console.log(data);
                ...
                fetch('http://localhost:3000/sendrequest', {
                    ...
                    .then(data => {
                        ...
                        if(data.status==1)
                        {
                            connect_button.innerText='Connection Sent';
